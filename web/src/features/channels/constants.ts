...
export const CHANNEL_TYPE_NOVELAI = 64
...
> = {
  ...
  64: { descriptionKey: 'Connect to NovelAI image generation services with queue and billing' },
} satisfies Record<
...
const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  64, 1, 14, 24, 33, 43, 3, 41, 17, 45, 25, 26, 23, 48, 60, 58, 59, 61, 42, 34, 20,
